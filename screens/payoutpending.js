...
export default class App extends React.Component {
    ...
    updatepaymentfunction = (pid, cid, balance) => {
        fetch('http://tndevelopersbackend.000webhostapp.com/warzone/payoutupdate.php',{
        method:'POST',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json'
                        ...
                        <View>
                            <View style={styles.GridViewBlockStyle}>
                                <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'space-between' }}>
                                    ...
                                    <Text style={{ fontWeight: 'bold', textAlign: 'left', padding: 10, color: 'gray' }}>{item.date}</Text>
                                ...
                                <TouchableOpacity onPress={this.approvefunction.bind(this,item.amount,item.transid,item.reqid, item.pid, item.cid, item.balance)} style={styles.bottombuttonadd}>
